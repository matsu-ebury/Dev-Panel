const sprintData = {
    ...
    "DBA-2627SP03": {
        ...
        "epics": {
            "DBA-2687: Postmortem - Document Number sent on STR6": {"Done": 0, "Done in Sprint": 2, "Pending": 0, "Dropped": 0}, 
            "DBA-2857: PIX Refund Services": {"Done": 3, "Done in Sprint": 2, "Pending": 3, "Dropped": 3},  
            "DBA-2983: QR Code estático - Caminho crítico": {"Done": 9, "Done in Sprint": 2, "Pending": 0, "Dropped": 0},
            "DBA-2963: QR Code estático": {"Done": 2, "Done in Sprint": 2, "Pending": 2, "Dropped": 2},
            "DBA-3078: JDPI - Lista de APIv5.5.0 / JDPI - Anexo Pix Automático": {"Done": 0, "Done in Sprint": 1, "Pending": 0, "Dropped": 0},
            "DBA-3103: Transaction Monitoring API Integration": {"Done": 0, "Done in Sprint": 2, "Pending": 1, "Dropped": 2}
        },
        "run_causes": {"AccountCreation": 3, "STR6DocIgnored":1, "WrongFlow":3, "SettlementVlFalse": 1}
    },
    "DBA-2526SP28": {
        "effort": {"build": 87, "develop": 98, "refine": 2, "plannedDropped": 18, "runTickets": 9, "notPlanned": 8
        },
        "epics": {
            "DBA-2767: Plataforma - Migração Accounts": {"Done": 16, "Done in Sprint": 4, "Pending": 0, "Dropped": 0},  
            "DBA-2983: QR Code estático - Caminho crítico": {"Done": 2, "Done in Sprint": 7, "Pending": 0, "Dropped": 2},
            "DBA-2963: QR Code estático": {"Done": 0, "Done in Sprint": 2, "Pending": 4, "Dropped": 0},
            "DBA-3078: JDPI - Lista de APIv5.5.0 / JDPI - Anexo Pix Automático": {"Done": 0, "Done in Sprint": 1, "Pending": 0, "Dropped": 0}
        },
        "run_causes": {"AccountCreation": 3, "STR6DocIgnored":1, "WrongFlow":3, "SettlementVlFalse": 1}
    },
    "DBA-2526SP27": {
        "effort": {"build": 73, "develop": 85, "refine": 15, "plannedDropped": 35, "runTickets": 14, "notPlanned": 24
        },
        "epics": {    
            "DBA-2951: JDPI Atualização de Versão HSM-API": {"Done": 0, "Done in Sprint": 3, "Pending": 0, "Dropped": 0},
            "DBA-2767: Plataforma - Migração Accounts": {"Done": 12, "Done in Sprint": 4, "Pending": 4, "Dropped": 0},  
            "DBA-2301: [BK-TECH] HSM - JD": {"Done": 6, "Done in Sprint": 0, "Pending": 0, "Dropped": 1}, 
            "DBA-2983: QR Code estático - Caminho crítico": {"Done": 0, "Done in Sprint": 2, "Pending": 6, "Dropped": 5}
        },
        "run_causes": {"AccountCreation": 5, "STR6DocIgnored":3, "WrongFlow":3, "EngineTax": 2, "PartialCancelled": 1}
    },
    "DBA-2526SP26": {
    ...
    //     "epics": {          
    //         "DBA-2583: [BK-REG] JDPI - Lista de APIv5.4.4": {"Done": 0, "Done in Sprint": 1, "Pending": 0, "Dropped": 0},
    //         "DBA-2386: [BC Protege +] Service": {"Done": 0, "Done in Sprint": 2, "Pending": 10, "Dropped": 0},
    ...
    //     },
    //     "run_causes": {"AccountCreation": 15,"15KPixRule":5,"Questions":2,  "WrongFlow": 1, "CJ_timeout":1}
    // },
    // "DBA-2526SP18": {
    ...
    //         "DBA-2182: Sistemas que se integram com Conectores Parceiros": {"Done": 5, "Done in Sprint": 1, "Pending": 0, "Dropped": 0},
    ...
    //         "DBA-2182: Sistemas que se integram com Conectores Parceiros": {"Done": 5, "Done in Sprint": 1, "Pending": 1, "Dropped": 1},
    //         "DBA-2263: [Testes] Withdrawal": {"Done": 1, "Done in Sprint": 4, "Pending": 9, "Dropped": 0},
    //         "DBA-2342: Dashboard com visualizações de negócios - Wallet": {"Done": 1, "Done in Sprint": 1, "Pending": 0, "Dropped": 0},
    //         "DBA-2319: [FOUNDATIONS] Metricas de disponibilidade": {"Done": 1, "Done in Sprint": 1, "Pending": 0, "Dropped": 0},
    //         "DBA-2419: [BK-REG] JDSPB - Catálogo de Mensagens 5.11 e Implementações de Segurança": {"Done": 0, "Done in Sprint": 2, "Pending": 0, "Dropped": 0}
    //     },
    //     "run_causes": {"AccountCreation":3, "15KPixRule":2, "IRCalculation": 1,"WrongFlow": 1}
    // },
    // "DBA-2526SP15": {
    ...
    //     "epics": {                
    //         "DBA-2216: [BK15] Pagando  Pix para pessoas não cadastradas": {"Done": 0, "Done in Sprint": 1, "Pending": 5, "Dropped": 3},
    //         "DBA-2216: [BK15] Cobrando  Pix para pessoas não cadastradas": {"Done": 0, "Done in Sprint": 1, "Pending": 5, "Dropped": 3},
    ...
    //         "DBA-1957: Receber status dos profiles via fila do Digital - NRA": {"Done": 0, "Done in Sprint": 1, "Pending": 0, "Dropped": 0},
    //         "DBA-1958: Relatório de transações - NRA": {"Done": 2, "Done in Sprint": 1, "Pending": 0, "Dropped": 0},
    //         "DBA-1862: Settlement - Conciliacao A Menor": {"Done": 4, "Done in Sprint": 1, "Pending": 0, "Dropped": 0},
    //         "DBA-1783: Account - Conciliacao A Menor": {"Done": 1, "Done in Sprint": 1, "Pending": 0, "Dropped": 0},
    //         "DBA-1911: SWIFT | Foundations - Adoption of the ISO 20022": {"Done": 1, "Done in Sprint": 1, "Pending": 1, "Dropped": 0},
    //         "DBA-2052: Disponibilizar campo infEntreClientes": {"Done": 0, "Done in Sprint": 4, "Pending": 1, "Dropped": 1},
    //         "DBA-2044: Foundations - Pix para estrangeiros": {"Done": 0, "Done in Sprint": 2, "Pending": 0, "Dropped": 0},
    //         "DBA-2039: Iniciativas de Plataforma [NOT PLANNED]": {"Done": 2, "Done in Sprint": 1, "Pending": 2, "Dropped": 0}
    //     },
    //     "run_causes": {"ValuePaidWrong":5, "WrongFlow": 3, "PartialCancelled": 1, "AccountCreation": 5, "DoubleClickConcMN": 1, "TelaTranfInterna":1}
    // },
    // "DBA-2526SP7": {
    ...
    //         "DBA-1957: Receber status dos profiles via fila do Digital - NRA": {"Done": 0, "Done in Sprint": 0, "Pending": 0, "Dropped": 8},
    //         "DBA-1958: Relatório de transações - NRA": {"Done": 5, "Done in Sprint": 3, "Pending": 0, "Dropped": 5},
    ...
    //         "DBA-1957: Receber status dos profiles via fila do Digital - NRA": {"Done": 0, "Done in Sprint": 0, "Pending": 0, "Dropped": 5},
    //         "DBA-1958: Relatório de transações - NRA": {"Done": 0, "Done in Sprint": 5, "Pending": 5, "Dropped": 3},
    //         "DBA-1188: Settlement - Conciliacao A Menor": {"Done": 0, "Done in Sprint": 3, "Pending": 5, "Dropped": 13},
    //         "DBA-1694: Account - Conciliacao A Menor": {"Done": 0, "Done in Sprint": 13, "Pending": 14, "Dropped": 0},
    //         "DBA-1927: Atualização da Documentação Externa": {"Done": 0, "Done in Sprint": 5, "Pending": 15, "Dropped": 0},
    //         "DBA-1927: Expor Documentação Open API": {"Done": 5, "Done in Sprint": 5, "Pending": 0, "Dropped": 0},
    //         "DBA-1911: SWIFT | Foundations - Adoption of the ISO 20022": {"Done": 0, "Done in Sprint": 0, "Pending": 0, "Dropped": 8}
    //     },
...
const epicDataR2 = {
    ...
    "DBA-1783: Acccount - Conciliação a menor": { "Stories": 3, "Story Points": 21, "Progress": 100},
    "DBA-1958: Relatório de transações - NRA": { "Stories": 3, "Story Points": 13, "Progress": 100},
    "DBA-1912: Atualização da Documentação Externa": { "Stories": 3, "Story Points": 20, "Progress": 100},
    "DBA-1957: Receber status dos profiles via fila do Digital - NRA": { "Stories": 1, "Story Points": 8, "Progress": 100},
...
const epicData = {
    ...
    "DBA-2983: QRCode estático - Caminho Critico": { "Stories": 9, "Story Points": 107, "Progress": 81},
    "DBA-2963: QRCode estático": { "Stories": 6, "Story Points": 58, "Progress": 42},
...
const progress = {
    "DBA-2025SP33": {"planned": 53, "completed": 65},
    "DBA-2025SP34": {"planned": 77, "completed": 74},
    "DBA-2025SP35": {"planned": 66, "completed": 68},
    "DBA-2526SP1": {"planned": 65, "completed": 89.5},
    "DBA-2526SP2": {"planned": 31.5, "completed": 50.5},
    "DBA-2526SP3": {"planned": 56, "completed": 86},
    "DBA-2526SP4": {"planned": 51, "completed": 60},
    "DBA-2526SP5": {"planned": 79, "completed": 91},
    "DBA-2526SP6": {"planned": 78, "completed": 61.5},
    "DBA-2526SP7": {"planned": 86, "completed": 81.5},
    "DBA-2526SP8": {"planned": 75, "completed": 99},
    "DBA-2526SP9": {"planned": 1, "completed": 39},
    "DBA-2526SP10": {"planned": 13, "completed": 21},
    "DBA-2526SP11": {"planned": 84, "completed": 52},
    "DBA-2526SP12": {"planned": 98, "completed": 44},
    "DBA-2526SP13": {"planned": 54, "completed": 69},
    "DBA-2526SP14": {"planned": 50, "completed": 81},    
    "DBA-2526SP15": {"planned": 81, "completed": 90},
    "DBA-2526SP16": {"planned": 83, "completed": 81},   
    "DBA-2526SP17": {"planned": 75, "completed": 76},
    "DBA-2526SP18": {"planned": 64, "completed": 49},  
    "DBA-2526SP19": {"planned": 99, "completed": 109},   
    "DBA-2526SP20": {"planned": 66, "completed": 82},  
    "DBA-2526SP21": {"planned": 69, "completed": 75},  
    "DBA-2526SP22": {"planned": 68, "completed": 92},
    "DBA-2526SP23": {"planned": 84, "completed": 93},    
    "DBA-2526SP24": {"planned": 80, "completed": 96},
    "DBA-2526SP25": {"planned": 89, "completed": 39},
